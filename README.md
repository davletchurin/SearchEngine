...
* **Умный поиск и ранжирование:** Вычисление абсолютной и относительной релевантности (TF-IDF подход) на основе частоты лемм на страницах.
...
```
Приложение и Dashboard будут доступны по адресу: **http://localhost:8080/**
...
- [ ] Расширение покрытия юнит-тестами.
